...
import cn.daydayup.dev.workflow.checkpoint.BaseCheckpointSaver;
import cn.daydayup.dev.workflow.checkpoint.Checkpoint;
import cn.daydayup.dev.workflow.exception.GraphInitKeyErrorException;
import cn.daydayup.dev.workflow.exception.GraphInterruptException;
...
import cn.daydayup.dev.workflow.internal.node.ParallelNode;
import cn.daydayup.dev.workflow.state.StateSnapshot;
...
public class CompiledGraph {
	...
	private String nextNodeId(EdgeValue route, Map<String, Object> state, String nodeId, OverAllState overAllState)
		...
		if (route.value() != null) {
			...
			cn.daydayup.dev.workflow.action.AsyncEdgeAction condition = route.value().action();
